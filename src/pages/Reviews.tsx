    ...
    <Layout>
      <section className="py-12">
        <div className="container">
          <h1 className="mb-2 font-heading text-3xl font-bold text-foreground md:text-4xl">Отзывы наших клиентов</h1>
          <p className="mb-8 font-body text-muted-foreground">
            Средний рейтинг: <span className="font-semibold text-primary">{avgRating}</span> из 5 · {reviews.length} отзывов
          </p>
